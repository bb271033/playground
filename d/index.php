...
<body>
<?php
echo '<div data-role="page" id="demo-intro" class="jqm-demos">
...
<div data-role="page" id="demo-page" data-title="Cars">
    ...
    <div role="main" class="ui-content">
        ...
        <ul data-role="listview">
            <li><a href="#" class="cars" id="bmw"><img src="../_assets/img/bmw-gpj.thumb" alt="BMW"><h2>BMW</h2><p>5 series</p></a></li>
